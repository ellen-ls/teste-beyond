...
function AddEndereco(props: Props) {
  ...
  return (
    <div>
     <h1 className="text-base font-semibold leading-7 text-gray-900">Cadastrar endereço</h1>
      <form onSubmit={onSubmitBtnClick}>
        ...
        <div>
          <input type="button" value="voltar" onClick={voltarBotao}  maxLength={4} className="w-28 border-solid border-2 border-#52525b rounded-xl cursor-pointer"/>
          <input type="submit" value="add endereço" className="w-28 border-solid border-2 border-#52525b rounded-xl cursor-pointer" />
        </div>
      </form>
    </div>
